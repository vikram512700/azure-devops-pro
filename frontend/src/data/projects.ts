...
export const projectsData: Record<string, Project> = {
  ...
  p2: {
    ...
    overview: "This project challenges you to automate daily operational tasks using pure Bash scripting. You will design and deploy a log rotation script that compresses and backs up application logs, and then schedule it using cron to ensure production servers never exhaust their disk space.",
    difficulty: "Beginner",
    category: "Azure Fundamentals",
    estimatedHours: 1.5,
    isFeatured: false,
  ...
  p3: {
    ...
    overview: "Master the intricacies of Git by navigating a complex repository scenario. You will learn how to enforce branch protection rules, resolve thorny merge conflicts manually, and use advanced operations like rebasing to maintain a pristine commit history in an enterprise environment.",
    difficulty: "Beginner",
    category: "Azure Fundamentals",
    estimatedHours: 2,
    isFeatured: false,
  ...
  p4: {
    ...
    overview: "Take a legacy Python application and containerize it to guarantee identical execution across developer laptops and production servers. You will write an optimized Dockerfile, handle environment variables, and build the final image according to industry best practices.",
  ...
  p5: {
    ...
    overview: "Expand your containerization skills by orchestrating a multi-tier web application using Docker Compose. You will define interconnected frontend, backend, and database services, set up custom bridge networks for DNS resolution, and configure persistent volumes to prevent data loss upon restarts.",
    difficulty: "Intermediate",
    category: "DevOps",
    estimatedHours: 2.5,
    isFeatured: true,
  ...
  p6: {
    ...
    overview: "Transition from manual deployments to full automation by constructing a CI/CD pipeline in GitHub Actions. You will configure workflows that automatically trigger upon code pushes, installing dependencies, running unit tests, and executing linting to validate application integrity before merge.",
    difficulty: "Intermediate",
